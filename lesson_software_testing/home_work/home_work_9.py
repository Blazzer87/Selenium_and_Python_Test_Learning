...
countries = driver.find_element(By.XPATH, '//*[@id="app-"]//span[text()="Geo Zones"]')
countries.click()
canada = driver.find_element(By.XPATH, '//*[@id="content"]//a[text()="Canada"]')
canada_html = canada.get_attribute('href')
driver.get(canada_html)
