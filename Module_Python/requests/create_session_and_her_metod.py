...
from Module_Python.requests.PreparedRequest import prepped
...
session.headers.update({'Authorization': 'Bearer token'})         # Устанавливает или получает заголовки, которые будут отправляться с каждым запросом.
